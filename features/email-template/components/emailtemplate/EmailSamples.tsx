...
const emailTemplates: EmailTemplate[] = [
    {
        ...
        subject: 'Application for Full Stack Engineer Position - Lalitkishor Kanojiya',
        html: `
  <p>Dear Hiring Manager,</p>
  <p>I am Lalitkishor Kanojiya, a dedicated Full Stack Engineer with over two years of experience building robust and scalable web applications using the MERN stack and Next.js.</p>
  ...
  <p>Warm regards,<br><strong>Lalitkishor Kanojiya</strong></p>
    `
    },
    // Add other templates...
]
